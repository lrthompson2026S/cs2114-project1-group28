...
public class Board {
    ...
    public class Upper {
        ...
        public boolean scoreSection(
            ...
            List<Upper.Section> scoreable =
                dice.getValidSections().stream()
            ...
            switch (section) {
                case Aces ->
                    sections.put(
                        section,
                        IntStream.of(
                                dice.getScoringValues(Upper.Section.Aces))
                            .sum());
                ...
                case Twos ->
                    sections.put(
                        section,
                        IntStream.of(
                                dice.getScoringValues(Upper.Section.Twos))
                            .sum());
                ...
                case Threes ->
                    sections.put(
                        section,
                        IntStream.of(
                                dice.getScoringValues(Upper.Section.Threes))
                            .sum());
                ...
                case Fours ->
                    sections.put(
                        section,
                        IntStream.of(
                                dice.getScoringValues(Upper.Section.Fours))
                            .sum());
                ...
                case Fives ->
                    sections.put(
                        section,
                        IntStream.of(
                                dice.getScoringValues(Upper.Section.Fives))
                            .sum());
                ...
                case Sixes ->
                    sections.put(
                        section,
                        IntStream.of(
                                dice.getScoringValues(Upper.Section.Sixes))
                            .sum());
            }
         ...
         * </p>
         *
         * @return the bonus value if the bonus threshold is reached,
         *         otherwise 0
         * @since 09.21.2026
         */
        public int bonus() {
            return this.totalScore() > BONUS_THRESHHOLD
                ? BONUS_VALUE
                : 0;
        }
        ...
        public List<Upper.Section> getAvailableSections() {
            List<Upper.Section> availableSections =
                new ArrayList<>();

            for (Map.Entry<Upper.Section, Integer> entry
                : sections.entrySet()) {
     ...
     * <p>
     * Lower <br>
     * Represents the lower section of the Yahtzee board.
     * </p>
     *
     * @author Lucas Thompson (lrthompson@vt.edu)
     * @version 09.21.2026
    ...
    public class Lower {
        ...
        public boolean scoreSection(
            ...
            switch (section) {
                case ThreeOfKind ->
                    sections.put(
                        section,
                        threeOfKindScore(dice));

                case FourOfKind ->
                    sections.put(
                        section,
                        fourOfKindScore(dice));
                ...
                case SmallStraight ->
                    sections.put(
                        section,
                        smallStraightScore(dice));

                case LargeStraight ->
                    sections.put(
                        section,
                        largeStraightScore(dice));
        ...
        public List<Lower.Section> getAvailableSections() {
            List<Lower.Section> availableSections =
                new ArrayList<>();

            for (Map.Entry<Lower.Section, Integer> entry
                : sections.entrySet()) {
        ...
        private Integer threeOfKindScore(DiceSet dice) {
            return IntStream.of(
                    dice.getScoringValues(
                        Lower.Section.ThreeOfKind))
                .sum();
        }
     ...
     * @since 09.21.2026
     */
    public boolean isScored(Section section)
        throws IllegalArgumentException {
     ...
     * @since 09.21.2026
     */
    public boolean scratch(Section section)
        throws IllegalArgumentException {
    ...
    /**
     * <p>
     * Calculates the total score of the board, including the upper
     * section bonus.
     * </p>
     *
