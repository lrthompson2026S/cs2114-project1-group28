...
/**
 * Represents a general type of user input.
 * Stores a prompt and a scanner that can be used
 * by different types of input.
 *
...
public abstract class Input
{
    ...
    public static class String extends Input
    {
        ...
        /**
         * Displays the prompt and returns the text entered
         * by the user.
         *
    ...
    /**
     * Represents an input where the user selects from
    ...
    public static class Option extends Input
    {
        ...
        /**
         * Creates a new Option input with the given prompt
         * and list of choices.
         *
         * @param prompt
         *     the message shown to the user
        ...
        /**
         * Displays the available options and asks the user
         * to choose one.
         *
         * Continues asking until the user enters a valid
         * number corresponding to one of the options.
         *
